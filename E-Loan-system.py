 ...
 # tc for client
    ...
    def register_loan():
        try:
            ...
            sql = """INSERT INTO loan_register(client_name, client_nic, loan_type, loan_amount,   loan_period, rate, installment, interest, total_amount,status  ) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s')""" % (
                client_name,
                client_nic,
                loan_type,
                amount,
